...
@section('content')
  <div class="container mid">
    <div class="row justify-content-center" align="center">
      ...
      <div class="form-group w-100">
        {{ Form::date('deadline', date_format(date_create($task->deadline),'Y-m-d'), array('class'=>'', 'id'=>'', 'placeholder'=>'Deadline')) }}
      ...
      <div class="form-group w-100">
        {{ Form::number('amount_left', null, array('class'=>'', 'id'=>'', 'placeholder'=>'Amount Left')) }}
        @if ($errors->has('amount_left'))
          <strong>{{ $errors->first('amount_left') }}</strong>
        @endif
      </div>
